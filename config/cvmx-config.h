...
#define CVMX_PKO_QUEUES_PER_PORT_INTERFACE2 1               /**< PKO queues per port for interface 2 */
#define CVMX_PKO_QUEUES_PER_PORT_INTERFACE3 1               /**< PKO queues per port for interface 3 */
#define CVMX_PKO_QUEUES_PER_PORT_INTERFACE4 1               /**< PKO queues per port for interface 4 */
